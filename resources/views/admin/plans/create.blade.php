        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="plan_type" id="plan_type"
                    ...
                    <option value="home" {{ old('plan_type') == 'home' ? 'selected' : '' }}>Home Plans</option>
                    <option value="corporate" {{ old('plan_type') == 'corporate' ? 'selected' : '' }}>Corporate Plans</option>
                    <option value="ott" {{ old('plan_type') == 'ott' ? 'selected' : '' }}>OTT & IP TV Plans</option>
                    <optgroup label="Legacy Types">
                        <option value="tv" {{ old('plan_type') == 'tv' ? 'selected' : '' }}>TV (Legacy)</option>
                        <option value="bundle" {{ old('plan_type') == 'bundle' ? 'selected' : '' }}>Bundle (Legacy)</option>
                    </optgroup>
                </select>
